...
export class AddTBLOrdersOpShipping1744266218196 implements MigrationInterface {
    name = 'AddTBLOrdersOpShipping1744266218196'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."orders_status_enum" AS ENUM('processing', 'shipped', 'delivered', 'canclled')`);
        ...
        await queryRunner.query(`ALTER TABLE "orders_products" ADD CONSTRAINT "FK_4eff63e89274f79195e25c5c115" FOREIGN KEY ("productId") REFERENCES "prodcuts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
